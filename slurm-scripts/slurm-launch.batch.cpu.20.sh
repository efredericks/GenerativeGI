...
# #SBATCH --job-name=fredericks-gengi-args-ec20 ## Name of job
# #SBATCH --output=fredericks-gengi-args-ec20.%j.%A.%a.out ##Name of output file
...
srun time python3 $d/deap_main.py --gens 100 --pop_size 100 --treatment ${SLURM_ARRAY_TASK_ID} --run_num ${SLURM_ARRAY_TASK_ID} --output_path $d/$w/${SLURM_ARRAY_TASK_ID} --lexicase --shuffle --ff_rms --ff_ut --ff_neg --ff_art
